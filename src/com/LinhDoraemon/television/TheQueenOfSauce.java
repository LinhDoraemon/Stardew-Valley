...
public class TheQueenOfSauce {
	...
	public static void runTheQueenOfSauce(Player p) {
		String WR_PREFIX = "§f§l<§d§lĐầu bếp§f§l> §e";

		p.sendTitle("§d§lNữ hoàng nấu ăn", "");

		p.sendMessage(WR_PREFIX + "Chào mừng bạn đến với chuyên mục nấu ăn !");
		p.sendMessage("");
